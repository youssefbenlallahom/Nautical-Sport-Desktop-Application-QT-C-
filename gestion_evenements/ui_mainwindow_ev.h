...
""));
        ...
        background_20 = new QLabel(tab);
        background_20->setObjectName(QStringLiteral("background_20"));
        background_20->setGeometry(QRect(0, 0, 1366, 761));
        background_20->setPixmap(QPixmap(QString::fromUtf8(":/background_3.png")));
        background_20->setScaledContents(true);
...
""));
        QIcon icon1;
        icon1.addFile(QStringLiteral("../../../Downloads/anyrgb.com.png"), QSize(), QIcon::Normal, QIcon::Off);
        submit_ev->setIcon(icon1);
        submit_ev->setAutoDefault(true);
        background_21 = new QLabel(tab_2);
        background_21->setObjectName(QStringLiteral("background_21"));
        background_21->setGeometry(QRect(0, 0, 1366, 761));
        background_21->setPixmap(QPixmap(QString::fromUtf8(":/background_3.png")));
        background_21->setScaledContents(true);
...
""));
        ...
        tabe->setGeometry(QRect(330, 230, 661, 331));
...
"}"));
        ...
        background_19 = new QLabel(tab_6);
        background_19->setObjectName(QStringLiteral("background_19"));
        background_19->setGeometry(QRect(0, 0, 1366, 761));
        background_19->setPixmap(QPixmap(QString::fromUtf8(":/background_3.png")));
        background_19->setScaledContents(true);
...
"}"));
        ...
        background_22 = new QLabel(tab_3);
        background_22->setObjectName(QStringLiteral("background_22"));
        background_22->setGeometry(QRect(0, 0, 1366, 761));
        background_22->setPixmap(QPixmap(QString::fromUtf8(":/background_3.png")));
        background_22->setScaledContents(true);
...
""));
        ...
        tab_liste->setGeometry(QRect(350, 230, 651, 331));
...
""));
        ...
        background_23 = new QLabel(tab_4);
        background_23->setObjectName(QStringLiteral("background_23"));
        background_23->setGeometry(QRect(0, 0, 1366, 761));
        background_23->setPixmap(QPixmap(QString::fromUtf8(":/background_3.png")));
        background_23->setScaledContents(true);
        listView = new QListView(tab_4);
        listView->setObjectName(QStringLiteral("listView"));
        listView->setGeometry(QRect(290, 240, 281, 241));
...
""));
        ...
        calendarWidget->setGeometry(QRect(650, 200, 411, 301));
        boutton_valider = new QPushButton(tab_4);
        boutton_valider->setObjectName(QStringLiteral("boutton_valider"));
        boutton_valider->setGeometry(QRect(370, 490, 121, 41));
        boutton_valider->setStyleSheet(QLatin1String("border-radius: 20px;\n"
"color: rgb(255, 255, 255);\n"
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        boutton_valider->setText(QApplication::translate("MainWindow", "Valider", Q_NULLPTR));
